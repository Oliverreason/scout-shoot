...
CubeTestGame::CubeTestGame( HINSTANCE hInstance, int nCmdShow)
    : GameWin( hInstance, nCmdShow, TEXT("Cube test game"))
{
}


CubeTestGame::~CubeTestGame(void)
{
}

void CubeTestGame::Initialize( void )
{
    GameWin::Initialize();
...
void CubeTestGame::LoadContent( void )
{
    GameWin::LoadContent();
...
void CubeTestGame::UnloadContent( void )
{
...
void CubeTestGame::Draw( GameTime gameTime )
{
...
void CubeTestGame::Update( GameTime gameTime )
{
...
void CubeTestGame::LoadAndInitialEffect()
{
...
void CubeTestGame::UnLoadEffect()
{
    if (m_pEffectTest)
